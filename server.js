...
const APP_NAME = process.env.APP_NAME || 'Poderosa-COMM Visual Engine';
const OPERATION_NAME = process.env.OPERATION_NAME || 'Poderosa';
...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      health: '/health',
      tests: '/test-slide{numero}-png',
      render: '/render/slide{numero}'
    },
    slides: [10, 11, 12, 13, 14, 15, 17, 18, 19]
  });
});
...
app.get('/health', (req, res) => {
  res.json({
    ...
    service: APP_NAME,
    operation: OPERATION_NAME,
    message: 'Motor visual de Poderosa activo',
...
function getSampleSlide10() {
  return normalizeSlide10Data({
    titulo: 'ATENCIONES EN LA OPERACIÓN PODEROSA - ABRIL 2026',
    periodo: 'Abril 2026',
    logoText: 'COMM',
    diasPeriodo: 30,
    totalAtenciones: 137,
...
function getSampleSlide11() {
  return normalizeSlide11Data({
    titulo: 'Poderosa - Abril 2026 - Atenciones por Tipo y Evolución Mensual',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide12() {
  return normalizeSlide12Data({
    titulo: 'Poderosa - Abril 2026 - Incidentes vs Requerimientos',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide13() {
  return normalizeSlide13Data({
    titulo: 'Poderosa - Abril 2026 - Detalle de Requerimientos e Incidentes',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide14() {
  return normalizeSlide14Data({
    titulo: 'Poderosa - Abril 2026 - Top 10 Requerimientos',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide15() {
  return normalizeSlide15Data({
    titulo: 'Poderosa - Abril 2026 - Top 10 Incidentes',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide17() {
  return normalizeSlide17Data({
    titulo: 'Poderosa - Abril 2026 - Top Suministros General',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide18() {
  return normalizeSlide18Data({
    titulo: 'Poderosa - Abril 2026 - Suministros en Requerimientos',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function getSampleSlide19() {
  return normalizeSlide19Data({
    titulo: 'Poderosa - Abril 2026 - Suministros en Incidentes',
    periodo: 'Abril 2026',
    logoText: 'COMM',
...
function normalizeSlide10Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `ATENCIONES EN LA OPERACIÓN ${OPERATION_NAME.toUpperCase()} - ${body.periodo || 'PERIODO'}`,
...
function normalizeSlide13Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `${OPERATION_NAME} - ${body.periodo || 'Periodo'} - Detalle de Requerimientos e Incidentes`,
...
function normalizeSlide14Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `${OPERATION_NAME} - ${body.periodo || 'Periodo'} - Top 10 Requerimientos`,
...
function normalizeSlide15Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `${OPERATION_NAME} - ${body.periodo || 'Periodo'} - Top 10 Incidentes`,
...
function normalizeSlide17Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `${OPERATION_NAME} - ${body.periodo || 'Periodo'} - Top Suministros General`,
...
function normalizeSlide18Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `${OPERATION_NAME} - ${body.periodo || 'Periodo'} - Suministros en Requerimientos`,
...
function normalizeSlide19Data(body) {
  ...
  return {
    titulo:
      body.titulo ||
      `${OPERATION_NAME} - ${body.periodo || 'Periodo'} - Suministros en Incidentes`,
